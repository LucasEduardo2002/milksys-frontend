        ...
        <LayoutBaseDePagina titulo="Cadastro de Produtores">
            <Paper sx={{ p: 3, mb: 3 }}>
                ...
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={12} container justifyContent="flex-end" spacing={1} sx={{ mt: 1 }}>
                        {isEditMode && <Grid item><Button variant="outlined" onClick={handleCancel}>Cancelar</Button></Grid>}
                        <Grid item><Button variant="contained" onClick={handleSave}>{isEditMode ? 'Salvar Alterações' : 'Cadastrar'}</Button></Grid>
                    </Grid>
                </Grid>
            </Paper>
            ...
            <Paper sx={{ p: 3 }}>
                <Box display="flex" justifyContent="space-between" mb={2}>
                    ...
                    <SearchField onSearchChange={setBusca} placeholder="Buscar por nome ou CPF..." />
                </Box>
                <TableContainer>
